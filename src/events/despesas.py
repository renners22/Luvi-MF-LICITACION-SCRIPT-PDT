...
def run(cnpj: str, start_date: str = DEFAULT_START_DATE, end_date: str | None = None, fases: str = "1,2,3"):
    ...
    with SessionLocal() as sess:
        sess.tenant_cnpj = cnpj  # para tenant.cnpj en Mongo
...
if __name__ == "__main__":
    ...
    args = ap.parse_args()
    run(args.cnpj, args.start, args.end, args.fases)
